...
# DF_PATH = os.path.join(BASE_DIR, "pickle Files\df.pkl")
# INDICES_PATH = os.path.join(BASE_DIR, "pickle Files\indices.pkl")
# TFIDF_MATRIX_PATH = os.path.join(BASE_DIR, "pickle Files\tfidf_matrix.pkl")
# TFIDF_PATH = os.path.join(BASE_DIR, "pickle Files\tfidf.pkl")
